...
export function Events() {
    ...
    return (
        <div>
            <h1>Events</h1>
            <p>
                På denne side finder du vores kalender for events, disse events findes også på vores facebook side. I
                bunden af siden finder du en liste over de events der afholdes årligt samt tidspunkter for disse events.
            </p>
